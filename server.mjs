...
function saveSmackPostsToDisk() {
  return fs.writeFile(SMACK_POSTS_FILE, JSON.stringify(smackPosts, null, 2), "utf8");
}
...
app.post("/api/smack", (req, res) => {
  ...
  // Keep persistence promise-based (no await) to avoid merge-related async syntax regressions on deploy.
